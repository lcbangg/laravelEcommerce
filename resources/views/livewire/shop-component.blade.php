                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-content">
                        {{-- <ul class="list-style vertical-list has-count-index">
                            ...
                            <li class="list-item"><a class="filter-link " href="#">Pink</a></li>
                        </ul> --}}
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="pink" id="pink" wire:model="color">
                            <label for="color-pink">Pink</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="red" id="red" wire:model="color">
                            <label for="color-red">Red</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="yellow" id="yellow" wire:model="color">
