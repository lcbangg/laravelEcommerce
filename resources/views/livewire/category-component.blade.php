    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                @foreach($productAttributes as $prA)
                <div class="widget mercado-widget filter-widget">
                    <h2 class="widget-title">{{$prA->name}}</h2>
                    <div class="widget-content">
                        @foreach($prA->attributeValues as $p)
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{$p->value}}" id="{{$p->value}}" wire:model="filter">
                            <label for="{{$prA->name}}">{{$p->value}}</label>
                        </div>
                        @endforeach
                        {{-- {{dd($prA->attributeValues)}} --}}
                    </div>               
                </div><!-- Color -->
                @endforeach
                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-content">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="all" wire:model="filter">
                            <label for="{{$prA->name}}">All</label>
                        </div>
                        @foreach($prA->attributeValues as $p)
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{$p->value}}" id="{{$p->value}}" wire:model="filter">
